...
public class Condition2 {
	...
	private PriorityScheduler.PriorityQueue priorityQueue;
	...
	public Condition2(Lock conditionLock) {
		...
		this.priorityQueue = priorityScheduler.new PriorityQueue(false);
	}
	...
	public void sleep() {
		...
		// put the thread into the sleep queue
		priorityQueue.waitForAccess(KThread.currentThread());
	...
	public void wake() {
		...
		// wake the thread from queue if queue is not null
		if(priorityQueue.pickNextThread() !=null){
			priorityQueue.nextThread().ready();
		}
	...
	public void wakeAll() {
		...
		KThread nextThread = priorityQueue.nextThread();
		while(nextThread != null){
			nextThread.ready();
			nextThread = priorityQueue.nextThread();
		}
	 ...
	 */
        public void sleepFor(long timeout) throws InterruptedException {
			Lib.assertTrue(conditionLock.isHeldByCurrentThread());
			boolean intStatus = Machine.interrupt().disable();
...
//	}
	...
	private static void sleepForTest1 () throws InterruptedException {
		Lock lock = new Lock();
