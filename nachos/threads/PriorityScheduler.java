...
public class PriorityScheduler extends Scheduler {
	...
	protected class PriorityQueue extends ThreadQueue {
		private java.util.PriorityQueue<KThread> waitQueue = new java.util.PriorityQueue<>((t1, t2) -> getPriority(t2) - getPriority(t1));
		...
		protected ThreadState pickNextThread() {
			...
			return new ThreadState(waitQueue.peek());
		}
